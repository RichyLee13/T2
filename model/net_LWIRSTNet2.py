...
class LW_IRST_ablation(nn.Module):
    def __init__(self, n_classes=1, encoder_relu=False, decoder_relu=True, channel=(8, 32, 64), dilations=(2,4,8,16), kernel_size=(3,5,7,9), padding=(1,2,3,4)):
        ...
        self.output_1 = nn.Conv2d(8, 1, 1)
        self.output_2 = nn.Conv2d(32, 1, 1)
        self.output_3 = nn.Conv2d(64, 1, 1)
    ...
    def forward(self, x ,warm_flag=False):
        ...
        if warm_flag:
            mask0 = x6
            mask1 = self.output_1(x5)
            mask2 = self.output_2(x4)
            mask3 = self.output_3(x3)
...
if __name__ == '__main__':
    ...
    _ , out = model(inputs,warm_flag = True)
